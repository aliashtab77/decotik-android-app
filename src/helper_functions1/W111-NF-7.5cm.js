// دیوار جدا کننده با یک ردیف سازه و یک لایه صفحه گچی w111
// استانداردNF
// 7.5 cm
import {
  givePrices,
...
const data = [
  {n: 'سازه استاد C50', z: 2},
  {n: 'سازه رانر U50', z: 0.9},
  {n: 'نوار عایق پشت چسبدار 4*15', z: 2.4},
  {n: 'میخ مهاری فولادی سقفی m6*40mm', z: 0.7},
  {n: 'پیچ رولپلاگ m6*60mm', z: 1.6},
  {n: 'RG 12.5', z: 2},
  {n: 'TN25', z: 20},

];

export async function handel6(v, o) {
  const price = [];
